...
**Current phase: Phase 218 closed (NAS live verify of Phase 217).** Next: Phase 219
``most_recent_labeled_outcome_label_schema_version`` (ADR-0220) then Phase 220 NAS verify
(ADR-0221). Phases 177–218 closed. See
