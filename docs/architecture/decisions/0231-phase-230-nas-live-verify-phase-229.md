# ADR-0231: Phase 230 NAS Live Verification of Phase 229 (draft)
...
Phase 229 would add ``scan_labeled_freshness_lag_trading_days`` on evidence summary
...
3. Authenticated evidence-summary includes ``scan_labeled_freshness_lag_trading_days``
   (null OK when either as_of date missing; checklist item TBD).
