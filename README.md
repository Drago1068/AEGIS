...
**Current phase: Phase 189 implemented (evidence summary latest calibration method version).** Next:
Phase 190 NAS backend+frontend verify (ADR-0191). Phases 177–188 closed; Phase 189 on HEAD
