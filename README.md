...
**Current phase: Phase 32 (calibration readiness JSON export).** Authenticated
`GET /research/{symbol}/calibration-readiness/export` downloads readiness diagnostics
(ADR-0033). See
