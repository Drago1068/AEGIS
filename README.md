...
**Current phase: Phase 173 drafted (evidence summary latest assessment id).** Next: implement
ADR-0174, then Phase 174 NAS backend+frontend verify. Phases 143–172 closed on ``004d1f5``.
See
