...
**Current phase: Phase 177 drafted (evidence summary latest calibration id).** Next: implement
ADR-0178, then Phase 178 NAS backend+frontend verify. Phases 143–176 closed on ``8836fd2``.
See
