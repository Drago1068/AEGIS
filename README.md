...
**Current phase: Phase 193 implemented (evidence summary latest calibration state).** Next:
Phase 194 NAS backend+frontend verify (ADR-0195). Phases 177–192 closed; Phase 193 on HEAD
