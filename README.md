...
**Current phase: Phase 195 implemented (evidence summary latest calibration probability confidence).** Next:
Phase 196 NAS backend+frontend verify (ADR-0197). Phases 177–194 closed; Phase 195 on HEAD
