...
**Current phase: Phase 87 draft (outcome-label download uses loaded assessment id).** Next:
implement ADR-0088, then Phase 88 NAS live verify. Phase 86 live verify closed
(``b77591b``). See
