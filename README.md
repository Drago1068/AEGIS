...
**Current phase: Phase 222 closed (NAS live verify of Phase 221).** Next: Phase 223
``most_recent_labeled_outcome_label_bar_source`` (ADR-0224) then Phase 224 NAS verify
(ADR-0225). Phases 177–222 closed. See
