...
- Status: Proposed (pending implementation after Phase 226)
- Date: 2026-07-31

## Context

Evidence summary will expose scan-labeled ``most_recent_labeled_outcome_label_computed_at``.
...
assessment ``latest_as_of_trading_date``.
