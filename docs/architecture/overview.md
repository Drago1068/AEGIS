...
Phase 183 surfaces top-level ``latest_calibration_corpus_count`` on evidence summary (see
...
Phase 184 live-verified that revision (see
[decisions/0185-phase-184-nas-live-verify-phase-183.md](decisions/0185-phase-184-nas-live-verify-phase-183.md)).
Phase 185 surfaces top-level ``latest_calibration_bucket_count`` on evidence summary (see
...
Phase 190 live-verified that revision (see
[decisions/0191-phase-190-nas-live-verify-phase-189.md](decisions/0191-phase-190-nas-live-verify-phase-189.md)).
Phase 191 surfaces top-level ``latest_calibration_schema_version`` on evidence summary (see
[decisions/0192-phase-191-evidence-summary-latest-calibration-schema-version.md](decisions/0192-phase-191-evidence-summary-latest-calibration-schema-version.md)).
Phase 192 live-verified that revision (see
[decisions/0193-phase-192-nas-live-verify-phase-191.md](decisions/0193-phase-192-nas-live-verify-phase-191.md)).
Phase 193 surfaces top-level ``latest_calibration_state`` on evidence summary (see
[decisions/0194-phase-193-evidence-summary-latest-calibration-state.md](decisions/0194-phase-193-evidence-summary-latest-calibration-state.md)).
Phase 194 live-verified that revision (see
[decisions/0195-phase-194-nas-live-verify-phase-193.md](decisions/0195-phase-194-nas-live-verify-phase-193.md)).
Phase 195 surfaces top-level ``latest_calibration_probability_confidence`` on evidence summary (see
[decisions/0196-phase-195-evidence-summary-latest-calibration-probability-confidence.md](decisions/0196-phase-195-evidence-summary-latest-calibration-probability-confidence.md)).
Phase 196 live-verified that revision (see
...
Phase 199 surfaces top-level ``latest_outcome_label_computed_at`` on evidence summary (see
...
Phase 200 live-verified that revision (see
...
Phase 204 live-verified that revision (see
...
Phase 208 live-verified that revision (see
[decisions/0209-phase-208-nas-live-verify-phase-207.md](decisions/0209-phase-208-nas-live-verify-phase-207.md)).
Phase 209 surfaces top-level ``latest_outcome_label_bar_source`` on evidence summary (see
[decisions/0210-phase-209-evidence-summary-latest-outcome-label-bar-source.md](decisions/0210-phase-209-evidence-summary-latest-outcome-label-bar-source.md)).
Phase 210 live-verified that revision (see
...
Phase 216 live-verified that revision (see
...
Phase 224 live-verified that revision (see
[decisions/0225-phase-224-nas-live-verify-phase-223.md](decisions/0225-phase-224-nas-live-verify-phase-223.md)).
Phase 225 surfaces top-level ``most_recent_labeled_outcome_label_computed_at`` for scan-labeled
computed_at (see
...
Phase 226 live-verified that revision (see
...
Phase 234 live-verified that reason field (see
...
Phase 237 surfaces ``most_recent_unlabeled_labelable_as_of_trading_date`` for the next
backfill target (see
...
Phase 241 surfaces ``most_recent_unlabeled_assessment_id`` for unlabeled tip drill-down (see
...
Phase 245 surfaces ``latest_assessment_forward_bar_shortfall`` for backfill unlock timing
(see
...
Phase 246 live-verified that shortfall (see
[decisions/0247-phase-246-nas-live-verify-phase-245.md](decisions/0247-phase-246-nas-live-verify-phase-245.md)).
Phase 247 surfaces ``latest_assessment_required_label_end_date`` as the unlock calendar
companion (see
...
Phase 264 live-verified that field (see
...
Phase 277 shows that label on the operator IngestPanel (see
...
Phase 309 adds an explicit ready-horizons outcome-label path when tip is still blocked (see
...
Phase 313 keeps partial ready-horizons labels eligible for full-horizon backfill once max
horizon unlocks (see
...
Phase 319 adds a complete/partial badge on outcome-label history rows (see
