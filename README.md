...
**Current phase: Phase 106 draft (NAS live verify of Phase 105).** Next: redeploy frontend under
lab TLS after Phase 105 load-latest labels control. Phase 104 live verify closed
(``0bf44c2``). See
