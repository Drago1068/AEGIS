...
**Current phase: Phase 49 (prefer unlabeled label-ready outcome-label backfill).** Prefer
unlabeled as-of dates with forward-horizon closes so labeling grows the corpus (ADR-0050). See
