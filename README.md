...
**Current phase: Phase 99 draft (calibrations download names latest assessment id).** Next:
implement ADR-0100, then Phase 100 NAS live verify. Phase 98 live verify closed
(``bce9be3``). See
