...
**Current phase: Phase 278 closed (IngestPanel primary fetch fallback live-verified).**
Next (draft): Phase 279 evidence-summary primary fetch fallback (ADR-0280), then
Phase 280 NAS verify. See
