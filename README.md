...
**Current phase: Phase 127 drafted (extract outcome-label history section).** Next: implement
ADR-0128, then Phase 128 NAS frontend verify. Phase 126 live verify closed. See
