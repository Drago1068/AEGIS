...
**Current phase: Phase 167 implemented (evidence summary latest computed_at).** Next: Phase 168
NAS backend+frontend verify (ADR-0169). Phases 143–166 closed; Phase 167 on HEAD pending NAS
verify. See
