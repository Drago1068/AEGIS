...
**Current phase: Phase 128 draft (NAS live verify of Phase 127).** Next: redeploy frontend under
lab TLS after Phase 127 outcome-label section extract. Phase 126 live verify closed. See
