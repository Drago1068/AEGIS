...
**Current phase: Phase 107 draft (rename active outcome-label assessment id helper).** Next:
implement ADR-0108, then Phase 108 NAS live verify. Phase 106 live verify closed
(``759bd25``). See
