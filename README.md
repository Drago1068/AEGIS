...
**Current phase: Phase 139 drafted (extract backfill status banners).** Next: implement
ADR-0140, then Phase 140 NAS frontend verify. Phase 138 live verify closed. See
