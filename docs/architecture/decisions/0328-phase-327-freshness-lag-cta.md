# ADR-0328: Phase 327 Freshness-Lag Backfill CTA
...
callout did not point operators at existing opt-in ready-horizon backfill toolbar
actions. Tip max-horizon labeling remains calendar-blocked until ~2026-08-28; freshness
lag is actionable for catching up ready horizons without inventing bars.
...
- Callout CTA ``data-testid="evidence-freshness-lag-callout-cta"``.
