...
**Current phase: Phase 290 closed (labeling diagnostics group live-verified).**
Next (draft): Phase 291 mixed-unlabeled backlog callout (ADR-0292), then Phase 292 NAS
verify. See
