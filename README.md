...
**Current phase: Phase 282 closed (daily-bars tip fetch fallback live-verified).**
Next (draft): Phase 283 latest assessment label-readiness callout (ADR-0284), then
Phase 284 NAS verify. See
