...
**Current phase: Phase 42 (NAS live verify of Phase 41).** Redeploy under lab TLS and verify
multi-horizon readiness (`by_horizon`, alembic `0009`) on the live NAS (ADR-0043). See
