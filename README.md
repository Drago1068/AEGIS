...
**Current phase: Phase 280 closed (evidence-summary primary fetch fallback live-verified).**
Next (draft): Phase 281 daily-bars tip fetch fallback (ADR-0282), then Phase 282 NAS
verify. See
