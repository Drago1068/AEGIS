...
describe("ResearchAssessmentPanel", () => {
  ...
  beforeEach(() => {
    ...
    vi.mocked(getResearchEvidenceSummary).mockResolvedValue({
      ...
      latest_assessment_forward_bar_shortfall: null,
      latest_assessment_required_label_end_date: null,
      latest_assessment_last_available_label_bar_date: null,
      latest_assessment_min_horizon_forward_bar_shortfall: null,
      latest_assessment_min_horizon_required_label_end_date: null,
      stored_bar_calendar_lag_trading_days: null,
  ...
  it("shows evidence summary after refresh evidence summary", async () => {
    ...
    await waitFor(() => {
      ...
      expect(screen.getByTestId("evidence-latest-lookback-start-date")).toHaveTextContent(
        "2023-12-27",
      );
      ...
      expect(screen.getByTestId("evidence-latest-method-id")).toHaveTextContent(
        "daily_bar_research_v1",
      );
      ...
      expect(screen.getByTestId("evidence-latest-event-time")).toHaveTextContent(
        "2024-01-26T23:59:59Z",
      );
      expect(screen.getByTestId("evidence-latest-probability-confidence")).toHaveTextContent(
        "null",
      );
      ...
      expect(
        screen.getByTestId("evidence-most-recent-labeled-outcome-label-state"),
      ).toHaveTextContent("research_only");
      expect(
      ...
      expect(
        screen.getByTestId("evidence-latest-assessment-forward-bar-shortfall"),
      ).toHaveTextContent("20");
      expect(
        screen.getByTestId("evidence-latest-assessment-required-label-end-date"),
      ).toHaveTextContent("2024-02-28");
      expect(
        screen.getByTestId("evidence-latest-assessment-last-available-label-bar-date"),
      ).toHaveTextContent("2024-02-09");
      expect(
        screen.getByTestId("evidence-latest-assessment-min-horizon-forward-bar-shortfall"),
      ).toHaveTextContent("5");
      expect(
        screen.getByTestId("evidence-latest-assessment-min-horizon-required-label-end-date"),
      ).toHaveTextContent("2024-02-16");
      expect(
      ...
      expect(screen.getByTestId("evidence-latest-outcome-label-method-id")).toHaveTextContent(
      ...
      expect(screen.getByTestId("evidence-latest-calibration-computed-at")).toHaveTextContent(
        "2024-01-26T19:00:00Z",
      );
      ...
      expect(screen.getByTestId("evidence-latest-calibration-method-id")).toHaveTextContent(
        "research_calibration_v1",
      );
      expect(screen.getByTestId("evidence-latest-calibration-method-version")).toHaveTextContent(
        "1",
      );
      expect(screen.getByTestId("evidence-latest-calibration-schema-version")).toHaveTextContent(
        "1",
      );
      expect(screen.getByTestId("evidence-latest-calibration-state")).toHaveTextContent(
        "research_only",
      );
      expect(
