...
**Current phase: Phase 123 drafted (extract research assessment action toolbar).** Next:
implement ADR-0124, then Phase 124 NAS frontend verify. Phase 122 live verify closed. See
