...
**Current phase: Phase 131 drafted (extract calibration readiness section).** Next: implement
ADR-0132, then Phase 132 NAS frontend verify. Phase 130 live verify closed. See
