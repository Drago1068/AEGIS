...
**Current phase: Phase 34 (outcome-label history JSON export).** Authenticated
`GET /research/{symbol}/assessments/{id}/outcome-labels/export` downloads label history
(ADR-0035). See
