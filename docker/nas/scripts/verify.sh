...
print_checklist() {
  ...
  echo "124. Authenticated POST /market-data/ingest tip refresh + latest_trading_date (Phase 257-262; unchanged lag OK)"
...
echo "OK  Phase 262 ingest HTTP 200 results + latest_trading_date present"
