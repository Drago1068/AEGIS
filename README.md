...
**Current phase: Phase 187 implemented (evidence summary latest calibration method id).** Next:
Phase 188 NAS backend+frontend verify (ADR-0189). Phases 177–186 closed; Phase 187 on HEAD
