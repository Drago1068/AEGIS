...
**Current phase: Phase 67 (mixed label coverage on evidence summary).** Evidence summary
exposes mixed unlabeled count and latest mixed label bar source (ADR-0068). See
