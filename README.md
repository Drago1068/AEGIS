...
**Current phase: Phase 181 implemented (evidence summary latest calibration computed_at).** Next:
Phase 182 NAS backend+frontend verify (ADR-0183). Phases 143–180 closed; Phase 181 on HEAD
