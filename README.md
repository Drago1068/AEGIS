...
**Current phase: Phase 129 drafted (extract assessment history section).** Next: implement
ADR-0130, then Phase 130 NAS frontend verify. Phase 128 live verify closed. See
