...
**Current phase: Phase 82 draft (NAS live verify of Phase 81).** Next: redeploy frontend under
lab TLS after Phase 81 load-scan-labeled control. Phase 80 live verify closed. See
