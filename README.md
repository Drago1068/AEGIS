...
**Current phase: Phase 47 (label-ready assessment backfill candidates).** Prefer as-of dates
with stored forward-horizon closes so labeling can persist (ADR-0048). See
