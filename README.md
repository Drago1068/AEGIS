...
**Current phase: Phase 312 closed (ready-horizons backfill live-verified).**
Next (draft): Phase 313 full-horizon upgrade for partial labels (ADR-0314), then Phase 314
NAS verify. See
