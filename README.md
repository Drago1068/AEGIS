...
**Current phase: Phase 255 closed (stored-bar calendar lag).** Next (draft): Phase 256 NAS
live verify of Phase 255 (ADR-0257). Prefer product gaps that advance tip ingest over further
