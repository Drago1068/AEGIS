...
**Current phase: Phase 111 drafted (resolve outcome-label history load-kind helper).** Next:
implement ADR-0112, then Phase 112 NAS frontend verify. Phase 110 live verify closed. See
