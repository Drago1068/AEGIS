...
print_checklist() {
  ...
  echo "124. Authenticated POST /market-data/ingest tip refresh + latest_trading_date (Phase 257-264; unchanged lag OK)"
...
echo "OK  Phase 264 ingest HTTP 200 results + primary_latest_trading_date present"
