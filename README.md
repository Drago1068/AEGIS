...
**Current phase: Phase 243 closed (most recent unlabeled as_of).** Next: Phase 244 NAS live
verify (ADR-0245), then draft the next evidence/product gap. Prefer tip freshness over
nested UI extracts. See
