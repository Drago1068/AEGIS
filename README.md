...
**Current phase: Phase 197 implemented (evidence summary latest calibration assessment snapshot id).** Next:
Phase 198 NAS backend+frontend verify (ADR-0199). Phases 177–196 closed; Phase 197 on HEAD
