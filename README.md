...
**Current phase: Phase 294 closed (collapsible labeling diagnostics live-verified).**
Next (draft): Phase 295 primary fetch-fallback callout (ADR-0296), then Phase 296 NAS
verify. See
